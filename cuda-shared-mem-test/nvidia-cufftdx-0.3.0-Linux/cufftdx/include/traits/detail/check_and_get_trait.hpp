...
#        define CUFFTDX_DETAIL_EXECUTION_SM_VALUE 800
#    else
#        define CUFFTDX_DETAIL_EXECUTION_SM_VALUE __CUDA_ARCH__
#    endif
#else
#    define CUFFTDX_DETAIL_EXECUTION_SM_VALUE sm_of<Description>::value
#endif
        ...
        namespace __get_block_config {
            ...
            class helper_block_ct
            {
                ...
                using this_fft_block_fft_implementation =
                    typename database::detail::search_by_ept<this_fft_ept_v, typename block_fft_record_t::blobs>::type;
            ...
            public:
                ...
                // Suggested values of EPR and FPB
                using suggested_elements_per_thread = suggested_ept;
                using suggested_ffts_per_block      = suggested_fpb;
            ...
            public:
                ...
                static constexpr unsigned int workspace_size = 2 * this_fft_blue_size_v * sizeof(Description::value_type);
            ...
            class helper
            {
                ...
                // TODO: Give ability to force Bluestein.
                // Question: How?
                // 1. By using EPT. Example: Block FFT of size 31. We only have single thread implementation. If user
                // sets EPT to something !=31, we can switch to Bluestein. However, I don't know if that's needed and
                // efficient. We don't want user to use inefficient FFTs.
                // 2. I don't know
...
#else
                static constexpr bool is_bluestein_required_v  = is_bluestein_required<Description>::value;
                static constexpr bool is_bluestein_supported_v = is_bluestein_supported<Description>();
