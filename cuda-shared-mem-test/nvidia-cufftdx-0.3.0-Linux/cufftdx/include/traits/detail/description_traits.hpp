...
namespace cufftdx {
    namespace detail {
        ...
        template<unsigned int N>
        struct is_operator<fft_operator::stride, Stride<N>>: CUFFTDX_STD::true_type {};
        ...
        template<unsigned int N>
        struct get_operator_type<Stride<N>> {
            static constexpr fft_operator value = fft_operator::stride;
        };
