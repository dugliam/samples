...
#endif
            static constexpr bool has_stride = has_operator<fft_operator::stride, description_type>::value;
#ifndef CUFFTDX_DETAIL_TEST_ENABLE_STRIDE
            static_assert(!has_stride, "Stride<> feature is not implemented yet");
#endif
// #ifndef CUFFTDX_DETAIL_TEST_ENABLE_FP16
//             static_assert(!CUFFTDX_STD::is_same<__half, this_fft_precision_t>::value, "FP16 is not supported yet in cuFFTDx");
// #endif
            ...
            static constexpr bool has_one_stride = has_at_most_one_of<fft_operator::stride, description_type>::value;
            ...
            static_assert(has_one_stride, "Can't create FFT with two Stride<> expressions");
