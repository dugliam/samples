...
namespace cufftdx {
    namespace detail {
        ...
        class fft_block_execution: public fft_execution<Operators...>
        {
            ...
            using base_type = fft_execution<Operators...>;
            using typename base_type::this_fft_precision_t;
            using host_workspace_type = typename workspace_selector<this_type, base_type::is_complete>::type;
        ...
        protected:
            ...
            // SM70
            static constexpr bool valid_size_for_block_fp16_sm70 =
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 700 && base_type::has_sm) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, __half>::value) ||
                is_supported<__half, base_type::this_fft_size_v, base_type::this_fft_sm_v>::fp16_block_value;
            static constexpr bool valid_size_for_block_fp32_sm70 =
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 700 && base_type::has_sm) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, float>::value) ||
                is_supported<float, base_type::this_fft_size_v, base_type::this_fft_sm_v>::fp32_block_value;
            static constexpr bool valid_size_for_block_fp64_sm70 =
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 700 && base_type::has_sm) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, double>::value) ||
                is_supported<double, base_type::this_fft_size_v, base_type::this_fft_sm_v>::fp64_block_value;
            ...
            static constexpr bool valid_size_for_bluestein_sm70 =
                !CUFFTDX_STD::is_same<host_workspace_type, detail::bluestein_workspace<this_type>>::value ||
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 700 && base_type::has_sm) ||
            ...
            // SM75
            static constexpr bool valid_size_for_block_fp16_sm75 =
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 750) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, __half>::value) ||
                is_supported<__half, base_type::this_fft_size_v, base_type::this_fft_sm_v>::fp16_block_value;
            static constexpr bool valid_size_for_block_fp32_sm75 =
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 750) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, float>::value) ||
                is_supported<float, base_type::this_fft_size_v, base_type::this_fft_sm_v>::fp32_block_value;
            static constexpr bool valid_size_for_block_fp64_sm75 =
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 750) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, double>::value) ||
                is_supported<double, base_type::this_fft_size_v, base_type::this_fft_sm_v>::fp64_block_value;
            ...
            // Check requirements for Bluestein size
            // If we need Bluestein, we need to generate chirp using FP64 FFT of size next-power_of_2(2*N - 1)
            static constexpr bool valid_size_for_bluestein_sm75 =
                !CUFFTDX_STD::is_same<host_workspace_type, detail::bluestein_workspace<this_type>>::value ||
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 750) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, double>::value) ||
            ...
            // SM80
            static constexpr bool valid_size_for_block_fp16_sm80 =
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 800) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, __half>::value) ||
                is_supported<__half, base_type::this_fft_size_v, base_type::this_fft_sm_v>::fp16_block_value;
            static constexpr bool valid_size_for_block_fp32_sm80 =
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 800) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, float>::value) ||
                is_supported<float, base_type::this_fft_size_v, base_type::this_fft_sm_v>::fp32_block_value;
            static constexpr bool valid_size_for_block_fp64_sm80 =
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 800) ||
                !(CUFFTDX_STD::is_same<this_fft_precision_t, double>::value) ||
                is_supported<double, base_type::this_fft_size_v, base_type::this_fft_sm_v>::fp64_block_value;
            static_assert(valid_size_for_block_fp16_sm80,
                          "Block execution in fp16 precision on SM70 supports sizes in range [2; " STRINGIFY(CUFFTDX_DETAIL_SM800_FP16_MAX) "]");
            static_assert(valid_size_for_block_fp32_sm80,
                          "Block execution in fp32 precision on SM70 supports sizes in range [2; " STRINGIFY(CUFFTDX_DETAIL_SM800_FP32_MAX) "]");
            static_assert(valid_size_for_block_fp64_sm80,
                          "Block execution in fp64 precision on SM70 supports sizes in range [2; " STRINGIFY(CUFFTDX_DETAIL_SM800_FP64_MAX) "]");

            // SM80
            // Check requirements for Bluestein size
            // If we need Bluestein, we need to generate chirp using FP64 FFT of size next-power_of_2(2*N - 1)
            static constexpr bool valid_size_for_bluestein_sm80 =
                !CUFFTDX_STD::is_same<host_workspace_type, detail::bluestein_workspace<this_type>>::value ||
                !base_type::has_size || // Size<> was not defined
                !(base_type::this_fft_sm_v == 800) ||
                is_supported<double, base_type::this_fft_size_v, base_type::this_fft_sm_v>::blue_block_value;
        ...
        private:
            ...
            inline __device__ auto internal_execute(value_type* input,
                ...
                static constexpr auto function_id = fft_implementation_t::function_id;
                using scalar_type                 = typename value_type::value_type;
                database::detail::cufftdx_private_function<function_id, scalar_type, 1 /* dynamic */>(input,
                                                                                                      shared_memory);
            }
